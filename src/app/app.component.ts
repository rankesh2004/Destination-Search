...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [RouterOutlet, DestinationListComponent, FormsModule],
...
export class AppComponent {
  ...
  get filteredDestinations() {
    return this.destinationsListItem.filter(destination =>
      destination.name.toLowerCase().includes(this.searchInput.toLowerCase())
    );
  }
}
